...
(function () {
  ...
  var button = '<li>' +
    '<a target="_blank" class="btn btn-sm" href="' + twitterURL + '" style="line-height: 18px;" title="Share on Twitter" aria-label="Share on Twitter">' +
      '<span class="octicon" style="margin-top: -1px;">' +
